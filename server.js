...
app.use(session({secret: 'mipropiapalabra'})); 
...
app.get("/", (req,res)=>{
    ...
    req.session.nombre = "ACABA DE ENTRAR AL SISTEMA";
...
app.get("/breaking", (req, res) => {
    ...
    const personajes = [
        ...
        },
        {
            ...
            "img": "https://static.wikia.nocookie.net/breakingbad/images/7/78/Holly.JPG/revision/latest/scale-to-width-down/683?cb=20100413115129",
            "status": "Alive",
            "nickname": "Holly",
            "appearance": [
                2,
